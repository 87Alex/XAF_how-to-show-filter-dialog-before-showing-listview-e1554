    ...
    Public Class ShowFilterDialogController
        ...
        Protected Overrides Sub OnActivated()
            ...
            If showNavigationItemController IsNot Nothing Then
                Me.showNavigationItemController.CustomShowNavigationItem += AddressOf ShowNavigationItemController_CustomShowNavigationItem
            End If
        End Sub

        Private Sub ShowNavigationItemAction_Executed(ByVal sender As Object, ByVal e As ActionBaseEventArgs)
            Me.showNavigationItemController.ShowNavigationItemAction.Executed -= AddressOf ShowNavigationItemAction_Executed
...
'''    at ICSharpCode.CodeConverter.VB.NodesVisitor.VisitAssignmentExpression(AssignmentExpressionSyntax node) in D:\GitWorkspace\CodeConverter\CodeConverter\VB\NodesVisitor.cs:line 978
...
''' 
''' Input:
'''                 dialogCotnroller.Accepting += new System.EventHandler<DialogControllerAcceptingEventArgs>(this.dialogCotnroller_Accepting)
''' 
                dialogCotnroller.ViewClosed += AddressOf dialogCotnroller_ViewClosed
